...
| POST   | `/api/auth/login`           | Public                    | Login (via NextAuth callback) |
| POST   | `/api/auth/logout`          | Authenticated             | Logout (via NextAuth signout) |
| GET    | `/api/auth/me`              | Authenticated             | Get current user profile      |
| PATCH  | `/api/auth/me`              | Authenticated (Students)  | Update own profile            |
