...
export default function AppSidebar() {
  ...
  const menuItems = [
    ...
    { icon: Book, label: "الكتب", href: "/dashboard/books" },
    { icon: Users, label: "الموظفين", href: "/dashboard/employees" },
    { icon: GraduationCap, label: "الطلاب", href: "/dashboard/students" },
    { icon: ShoppingCart, label: "الطلبات", href: "/dashboard/requests" },
  ]
  return (
    <Sidebar
      side="right"
