...
import StudentMembershipStaus from "./student-membership-status"
import RecommendedBooks from "./recommended-books"
import StudentDashboardRequests from "./student-dashboard-requests"
  ...
  return (
    <>
      ...
      <div className="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
        <RecommendedBooks />
        <StudentDashboardRequests />
      </div>

      <StudentMembershipStaus user={user} />
    </>
  )
}
